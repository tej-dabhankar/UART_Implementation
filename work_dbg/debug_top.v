...
module edb_top (
    ...
    input  la0_probe7,
    input  [2:0] la0_probe8,
    input  [7:0] la0_probe9,
    input  [2:0] la0_probe10,
    input  la0_probe11,
    input  la0_probe12,
    input  la0_probe13,
    input  la0_probe14,
    input  [7:0] la0_probe15,
    input  la0_probe16,
    input  [7:0] la0_probe17,
    input  la0_probe18,
    input  la0_probe19,
    input  la0_probe20,
    input  la0_probe21,
    input  [7:0] la0_probe22,
    input  la0_probe23,
    input  la0_probe24,
    input  [2:0] la0_probe25,
    input  la0_probe26,
    input  la0_probe27,
    input  la0_probe28,
    input  [7:0] la0_probe29,
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'hed2a5ab69125414cb26d8fb13d7b9918 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
