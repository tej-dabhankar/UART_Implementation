...
module edb_top_manual (
    ...
    output bscan_TDO,
    input  vio0_clk,
    input  vio0_i_Rx_Serial,
    output vio0_o_Tx_Serial,
    output vio0_o_Tx_Active,
    output vio0_o_Tx_Done,
    input  la0_clk,
    input  la0_i_Rx_Serial
);
    ...
    edb_vio_top #(
        .NUM_PROBE_IN           ( 1 ),
        .NUM_PROBE_OUT          ( 3 ),
        .UUID           ( 128'hed402b458567487498cd7bee5fbb3fb2 ),
        .PROBE_IN0_WIDTH        ( 1 ),
        .PROBE_OUT0_WIDTH       ( 1 ),
        .PROBE_OUT1_WIDTH       ( 1 ),
        .PROBE_OUT2_WIDTH       ( 1 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( vio0_o_Tx_Serial ),
        .probe_out1         ( vio0_o_Tx_Active ),
        .probe_out2         ( vio0_o_Tx_Done ),
        .probe_out3         (  ),
        .probe_out4         (  ),
        .probe_out5         (  ),
        .probe_out6         (  ),
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h98357798f00f44d183fce71232f1db31 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 )
    ) la0 (
